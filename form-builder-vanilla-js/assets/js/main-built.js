...
if (
  ((function (e, t) {
    ...
    function i(e) {
      var t = (we[e] = {});
      return (
        se.each(e.match(ue) || [], function (e, n) {
          t[n] = !0;
        }),
        t
      );
    ...
    function r(e, n, i, r) {
      if (se.acceptData(e)) {
        ...
        if ((p && c[p] && (r || c[p].data)) || !l || i !== t)
          return (
            p || (u ? (e[s] = p = K.pop() || se.guid++) : (p = s)),
            c[p] || ((c[p] = {}), u || (c[p].toJSON = se.noop)),
            ("object" == typeof n || "function" == typeof n) &&
              (r
                ? (c[p] = se.extend(c[p], n))
                : (c[p].data = se.extend(c[p].data, n))),
            (o = c[p]),
            r || (o.data || (o.data = {}), (o = o.data)),
            i !== t && (o[se.camelCase(n)] = i),
            l ? null == (a = o[n]) && (a = o[se.camelCase(n)]) : (a = o),
            a
          );
      }
    }
        ...
        if (l[u]) {
          if (t && (i = n ? l[u] : l[u].data)) {
            se.isArray(t)
              ...
              : t in i
              ? (t = [t])
              : ((t = se.camelCase(t)), (t = t in i ? [t] : t.split(" ")));
            for (r = 0, o = t.length; o > r; r++) delete i[t[r]];
            if (!(n ? s : se.isEmptyObject)(i)) return;
          }
          (n || (delete l[u].data, s(l[u]))) &&
            (a
              ? se.cleanData([e], !0)
              : se.support.deleteExpando || l != l.window
              ? delete l[u]
              : (l[u] = null));
        }
      }
    ...
    function a(e, n, i) {
      if (i === t && 1 === e.nodeType) {
        var r = "data-" + n.replace(ke, "-$1").toLowerCase();
    ...
    function p(e, t, n) {
      if (((t = t || 0), se.isFunction(t)))
        return se.grep(e, function (e, i) {
      ...
      if ("string" == typeof t) {
        var i = se.grep(e, function (e) {
          return 1 === e.nodeType;
        });
        if (Re.test(t)) return se.filter(t, i, !n);
        t = se.filter(t, i);
      }
      return se.grep(e, function (e) {
    ...
    function v(e, t) {
      for (var n, i = 0; null != (n = e[i]); i++)
        se._data(n, "globalEval", !t || se._data(t[i], "globalEval"));
    }
    function g(e, t) {
    ...
    function y(e, n) {
      ...
      if (!a)
        for (a = [], i = e.childNodes || e; null != (r = i[o]); o++)
          !n || se.nodeName(r, n) ? a.push(r) : se.merge(a, y(r, n));
    ...
    function k(e, t) {
      for (var n, i = [], r = 0, o = e.length; o > r; r++)
        (n = e[r]),
          n.style &&
            ((i[r] = se._data(n, "olddisplay")),
            t
              ? (i[r] || "none" !== n.style.display || (n.style.display = ""),
                "" === n.style.display &&
                  T(n) &&
                  (i[r] = se._data(n, "olddisplay", N(n.nodeName))))
              : i[r] ||
                T(n) ||
                se._data(n, "olddisplay", se.css(n, "display")));
      for (r = 0; o > r; r++)
        (n = e[r]),
          n.style &&
            ((t && "none" !== n.style.display && "" !== n.style.display) ||
              (n.style.display = t ? i[r] || "" : "none"));
      return e;
    }
    function C(e, t, n) {
      var i = mt.exec(t);
    ...
    function E(e, t, n, i, r) {
      for (
        ...
        "margin" === n && (a += se.css(e, n + wt[o], !0, r)),
          i
            ? ("content" === n && (a -= se.css(e, "padding" + wt[o], !0, r)),
              "margin" !== n &&
                (a -= se.css(e, "border" + wt[o] + "Width", !0, r)))
            : ((a += se.css(e, "padding" + wt[o], !0, r)),
              "padding" !== n &&
                (a += se.css(e, "border" + wt[o] + "Width", !0, r)));
      return a;
    }
    function S(e, t, n) {
      ...
      if (0 >= r || null == r) {
        if (
          ...
          return r;
        (i = a && (se.support.boxSizingReliable || r === e.style[t])),
          (r = parseFloat(r) || 0);
      }
      ...
      return (
        n ||
          ...
          ("none" !== n && n) ||
            ((ut = (
              ut ||
              se("<iframe frameborder='0' width='0' height='0'/>").css(
                "cssText",
          ...
          if ("*" !== u && u !== r) {
            if (!(n = a[u + " " + r] || a["* " + r]))
              for (i in a)
                if (
                  ((o = i.split(" ")),
                  o[1] === r && (n = a[u + " " + o[0]] || a["* " + o[0]]))
                ) {
                  !0 === n
                    ? (n = a[i])
                    : !0 !== a[i] && ((r = o[0]), l.splice(s--, 0, r));
                  break;
                }
            if (!0 !== n)
              if (n && e.throws) t = n(t);
                ...
                try {
                  ...
                  return {
                    state: "parsererror",
                    error: n ? e : "No conversion from " + u + " to " + r,
                  };
                }
          }
          u = r;
    ...
    function F(e, t) {
      se.each(t, function (t, n) {
        for (
          var i = (tn[t] || []).concat(tn["*"]), r = 0, o = i.length;
          o > r;
          r++
        )
    ...
    function B(e, t, n) {
      ...
      for (P(c, u.opts.specialEasing); a > o; o++)
        if ((i = en[o].call(u, e, c, u.opts))) return i;
      return (
        F(u, c),
        se.isFunction(u.opts.start) && u.opts.start.call(e, u),
        se.fx.timer(se.extend(l, { elem: e, anim: u, queue: u.opts.queue })),
        u
    ...
    function R(e, t, n) {
      ...
      n.queue ||
        ...
        1 === e.nodeType &&
          ...
          "inline" === se.css(e, "display") &&
            "none" === se.css(e, "float") &&
            (se.support.inlineBlockNeedsLayout && "inline" !== N(e.nodeName)
              ? (f.zoom = 1)
              : (f.display = "inline-block"))),
        n.overflow &&
          ((f.overflow = "hidden"),
          se.support.shrinkWrapBlocks ||
            d.done(function () {
    ...
    var X,
      ...
      xe = function () {
        V.addEventListener
          ? (V.removeEventListener("DOMContentLoaded", xe, !1), se.ready())
          : "complete" === V.readyState &&
            (V.detachEvent("onreadystatechange", xe), se.ready());
      };
    (se.fn = se.prototype =
      {
        jquery: Z,
          ...
          if ("string" == typeof e) {
            ...
            if (r[1]) {
              if (
                ...
                de.test(r[1]) && se.isPlainObject(n))
              )
                for (r in n)
                  se.isFunction(this[r]) ? this[r](n[r]) : this.attr(r, n[r]);
              return this;
            }
            ...
            if (null != (e = arguments[l]))
              for (n in e)
                (i = s[n]),
                  (r = e[n]),
                  s !== r &&
                    (c && r && (se.isPlainObject(r) || (o = se.isArray(r)))
                      ? (o
                          ? ((o = !1), (a = i && se.isArray(i) ? i : []))
                          : (a = i && se.isPlainObject(i) ? i : {}),
                        (s[n] = se.extend(c, a, r)))
                      : r !== t && (s[n] = r));
          return s;
        }),
      se.extend({
        noConflict: function (t) {
          return (
            e.$ === se && (e.$ = Y), t && e.jQuery === se && (e.jQuery = J), se
          );
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function (e) {
          if (!0 === e ? !--se.readyWait : !se.isReady) {
            ...
            (se.isReady = !0),
              (!0 !== e && --se.readyWait > 0) ||
                (U.resolveWith(V, [se]),
                se.fn.trigger && se(V).trigger("ready").off("ready"));
          }
        },
        ...
        parseJSON: function (n) {
          return e.JSON && e.JSON.parse
            ...
            : "string" == typeof n &&
              (n = se.trim(n)) &&
              fe.test(n.replace(me, "@").replace(ve, "]").replace(he, ""))
            ? Function("return " + n)()
            : (se.error("Invalid JSON: " + n), t);
        },
        parseXML: function (n) {
          var i, r;
        ...
        map: function (e, t, i) {
          var r,
            ...
            l = [];
          if (s)
            for (; a > o; o++) null != (r = t(e[o], o, i)) && (l[l.length] = r);
          else for (o in e) null != (r = t(e[o], o, i)) && (l[l.length] = r);
          return ee.apply([], l);
        },
        guid: 1,
        proxy: function (e, n) {
        ...
        access: function (e, n, i, r, o, a, s) {
          ...
          if ("object" === se.type(i)) {
            o = !0;
            for (l in i) se.access(e, n, l, i[l], !0, a, s);
          } else if (
            r !== t &&
            ((o = !0),
            se.isFunction(r) || (s = !0),
      ...
      (se.ready.promise = function (t) {
        if (!U)
          if (((U = se.Deferred()), "complete" === V.readyState))
            setTimeout(se.ready);
          else if (V.addEventListener)
            V.addEventListener("DOMContentLoaded", xe, !1),
    ...
    (se.Callbacks = function (e) {
      e = "string" == typeof e ? we[e] || i(e) : se.extend({}, e);
      var n,
        r,
        o,
        a,
        ...
        p = function (t) {
          for (
            n = e.memory && t, r = !0, l = a || 0, a = 0, s = u.length, o = !0;
            u && s > l;
            l++
          )
          ...
          (o = !1),
            u && (c ? c.length && p(c.shift()) : n ? (u = []) : d.disable());
        },
        d = {
          add: function () {
            if (u) {
              ...
              (function t(n) {
                se.each(n, function (n, i) {
                  var r = se.type(i);
                  "function" === r
                    ? (e.unique && d.has(i)) || u.push(i)
                    : i && i.length && "string" !== r && t(i);
                });
              })(arguments),
                o ? (s = u.length) : n && ((a = t), p(n));
            }
            return this;
          },
          remove: function () {
            return (
              u &&
                se.each(arguments, function (e, t) {
                  for (var n; (n = se.inArray(t, u, n)) > -1; )
        ...
        when: function (e) {
          var t,
            ...
            u = function (e, n, i) {
              return function (r) {
                (n[e] = this),
                  (i[e] = arguments.length > 1 ? ne.call(arguments) : r),
                  i === t ? l.notifyWith(n, i) : --s || l.resolveWith(n, i);
              };
            };
          if (a > 1)
            for (t = Array(a), n = Array(a), i = Array(a); a > r; r++)
              o[r] && se.isFunction(o[r].promise)
                ? o[r]
                    .promise()
                    .done(u(r, i, o))
                    .fail(l.reject)
      ...
      (se.support = (function () {
        ...
        (s = V.createElement("input")),
          ...
          (l = V.createDocumentFragment()),
          l.appendChild(s),
          (n.appendChecked = s.checked),
          (n.checkClone = l.cloneNode(!0).cloneNode(!0).lastChild.checked),
          d.attachEvent &&
        ...
        for (p in { submit: !0, change: !0, focusin: !0 })
          d.setAttribute((u = "on" + p), "t"),
            (n[p + "Bubbles"] = u in e || !1 === d.attributes[u].expando);
        return (
          ...
          se(function () {
            ...
            s &&
              ...
              e.getComputedStyle &&
                ...
                (r = d.appendChild(V.createElement("div"))),
    ...
    se.extend({
      ...
      hasData: function (e) {
        return (
          !!(e = e.nodeType ? se.cache[e[se.expando]] : e[se.expando]) && !s(e)
        );
      },
      data: function (e, t, n) {
        return r(e, t, n, !1);
          ...
          if (e === t) {
            if (
              ...
              for (i = o.attributes; i.length > s; s++)
                (r = i[s].name),
                  r.indexOf("data-") ||
                    ((r = se.camelCase(r.substring(5))), a(o, r, l[r]));
    ...
    se.fn.extend({
      ...
      toggleClass: function (e, t) {
        ...
        return se.isFunction(e)
          ...
          : this.each(function () {
              if ("string" === n)
                for (
                  var r, o = 0, a = se(this), s = t, l = e.match(ue) || [];
                  (r = l[o++]);
      ...
      val: function (e) {
        ...
        return arguments.length
          ...
          : o
          ? ((n = se.valHooks[o.type] || se.valHooks[o.nodeName.toLowerCase()]),
            n && "get" in n && (i = n.get(o, "value")) !== t
              ? i
              : ((i = o.value),
                "string" == typeof i ? i.replace(Ne, "") : null == i ? "" : i))
          : void 0;
      },
    }),
      se.extend({
            ...
            get: function (e) {
              for (
                ...
                if (
                  ...
                  !(
                    (!n.selected && l !== r) ||
                    (se.support.optDisabled
                      ? n.disabled
                      : null !== n.getAttribute("disabled")) ||
                    (n.parentNode.disabled &&
                      se.nodeName(n.parentNode, "optgroup"))
                  ))
                ) {
          ...
          if (e && 3 !== s && 8 !== s && 2 !== s)
            return e.getAttribute === t
              ...
              : ((a = 1 !== s || !se.isXMLDoc(e)),
                a &&
                  ((n = n.toLowerCase()),
                  (o = se.attrHooks[n] || (je.test(n) ? Ee : Ce))),
                i === t
                  ? o && a && "get" in o && null !== (r = o.get(e, n))
                    ? r
                    : (e.getAttribute !== t && (r = e.getAttribute(n)),
                      null == r ? t : r)
                  : null !== i
                  ? o && a && "set" in o && (r = o.set(e, i, n)) !== t
                    ? r
          ...
          if (o && 1 === e.nodeType)
            for (; (n = o[r++]); )
              (i = se.propFix[n] || n),
                je.test(n)
                  ? !De && _e.test(n)
                    ? (e[se.camelCase("default-" + n)] = e[i] = !1)
                    : (e[i] = !1)
                  : se.attr(e, n, ""),
          ...
          tabIndex: {
            get: function (e) {
              ...
              return n && n.specified
                ? parseInt(n.value, 10)
                : Ae.test(e.nodeName) || ($e.test(e.nodeName) && e.href)
                ? 0
                : t;
            },
          },
        ...
        set: function (e, t, n) {
          return (
            !1 === t
              ? se.removeAttr(e, n)
              : (Le && De) || !_e.test(n)
              ? e.setAttribute((!De && se.propFix[n]) || n, n)
              : (e[se.camelCase("default-" + n)] = e[n] = !0),
            n
          );
        },
      }),
      ...
      se.support.hrefNormalized ||
        (se.each(["href", "src", "width", "height"], function (e, n) {
          se.attrHooks[n] = se.extend(se.attrHooks[n], {
            get: function (e) {
      ...
      se.support.optSelected ||
        (se.propHooks.selected = se.extend(se.propHooks.selected, {
          get: function (e) {
            var t = e.parentNode;
            return (
              t &&
      ...
      se.each(["radio", "checkbox"], function () {
        se.valHooks[this] = se.extend(se.valHooks[this], {
          set: function (e, n) {
            return se.isArray(n)
              ? (e.checked = se.inArray(se(e).val(), n) >= 0)
              : t;
          },
        });
      });
    ...
    (se.event = {
      ...
      add: function (e, n, i, r, o) {
        var a,
          ...
          m,
          v,
          g = 3 !== e.nodeType && 8 !== e.nodeType && se._data(e);
        if (g) {
          for (
            i.handler && ((a = i), (i = a.handler), (o = a.selector)),
              i.guid || (i.guid = se.guid++),
              (u = g.events) || (u = g.events = {}),
              (s = g.handle) ||
                ((s = g.handle =
                  function (e) {
                    return se === t || (e && se.event.triggered === e.type)
                      ? t
                      : se.event.dispatch.apply(s.elem, arguments);
                  }),
                (s.elem = e)),
              n = (n || "").match(ue) || [""],
              c = n.length;
            ...
            (l = Fe.exec(n[c]) || []),
              ...
              d.add &&
                (d.add.call(e, p), p.handler.guid || (p.handler.guid = i.guid)),
            ...
            if (
              ...
              a &&
                ...
                ((p.teardown && !1 !== p.teardown.call(e, h, v.handle)) ||
                  se.removeEvent(e, f, v.handle),
                delete l[f]);
            } else for (f in l) se.event.remove(e, f + t[u], n, i, !0);
          se.isEmptyObject(l) && (delete v.handle, se._removeData(e, "events"));
        }
      },
      trigger: function (n, i, r, o) {
        ...
        if (
          ...
          3 !== r.nodeType &&
            8 !== r.nodeType &&
            !Oe.test(h + se.event.triggered) &&
            (h.indexOf(".") >= 0 &&
              ((m = h.split(".")), (h = m.shift()), m.sort()),
            (c = 0 > h.indexOf(":") && "on" + h),
            (n = n[se.expando]
              ? n
              : new se.Event(h, "object" == typeof n && n)),
            (n.isTrigger = !0),
            (n.namespace = m.join(".")),
            ...
            (n.result = t),
            n.target || (n.target = r),
            (i = null == i ? [n] : se.makeArray(i, [n])),
            (d = se.event.special[h] || {}),
            o || !d.trigger || !1 !== d.trigger.apply(r, i)))
        ) {
          if (!o && !d.noBubble && !se.isWindow(r)) {
            for (
              u = d.delegateType || h, Oe.test(u + h) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              f.push(s), (l = s);
          ...
          for (a = 0; (s = f[a++]) && !n.isPropagationStopped(); )
            (n.type = a > 1 ? u : d.bindType || h),
              (p =
                (se._data(s, "events") || {})[n.type] && se._data(s, "handle")),
              p && p.apply(s, i),
              (p = c && s[c]) &&
                se.acceptData(s) &&
                p.apply &&
          ...
          if (
            ...
            !(
              ...
              (d._default && !1 !== d._default.apply(r.ownerDocument, i)) ||
              ("click" === h && se.nodeName(r, "a")) ||
              !se.acceptData(r) ||
              !c ||
              !r[h] ||
              se.isWindow(r)
            ...
            (l = r[c]), l && (r[c] = null), (se.event.triggered = h);
            try {
              r[h]();
            } catch (e) {}
            (se.event.triggered = t), l && (r[c] = l);
          }
          return n.result;
        }
      },
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            s = se.event.handlers.call(this, e, u), n = 0;
            ...
            for (
              ...
              (!e.namespace_re || e.namespace_re.test(a.namespace)) &&
                ...
                (e.data = a.data),
                (r = (
                  (se.event.special[a.origType] || {}).handle || a.handler
                ).apply(o.elem, l)) !== t &&
                  !1 === (e.result = r) &&
      ...
      fix: function (e) {
        ...
        var t,
          n,
          i = e,
          r = se.event.fixHooks[e.type] || {},
          o = r.props ? this.props.concat(r.props) : this.props;
        for (e = new se.Event(i), t = o.length; t--; )
          (n = o[t]), (e[n] = i[n]);
        return (
          e.target || (e.target = i.srcElement || V),
      ...
      simulate: function (e, t, n, i) {
        ...
        i ? se.event.trigger(r, null, t) : se.event.dispatch.call(t, r),
      ...
      se.support.submitBubbles ||
        (se.event.special.submit = {
            ...
            return (
              ...
              (se.event.add(
                ...
                function (e) {
                  var n = e.target,
                    i =
                      se.nodeName(n, "input") || se.nodeName(n, "button")
                        ? n.form
                        : t;
                  i &&
          ...
          teardown: function () {
            return (
              !se.nodeName(this, "form") &&
              (se.event.remove(this, "._submit"), t)
            );
          },
        }),
      se.support.changeBubbles ||
        (se.event.special.change = {
          ...
          teardown: function () {
            return se.event.remove(this, "._change"), !He.test(this.nodeName);
          },
        }),
      se.support.focusinBubbles ||
      ...
      se.fn.extend({
        ...
        triggerHandler: function (e, n) {
          var i = this[0];
          return i ? se.event.trigger(e, n, i, !0) : t;
        },
        hover: function (e, t) {
      ...
      se.each(
        ...
        function (e, t) {
          (se.fn[t] = function (e, n) {
            ...
            Me.test(t) && (se.event.fixHooks[t] = se.event.keyHooks),
            qe.test(t) && (se.event.fixHooks[t] = se.event.mouseHooks);
        }
      ),
      (function (e, t) {
        function n(e) {
          ...
          if (!_ && !i) {
            if ((r = pe.exec(e)))
              if ((a = r[1])) {
                ...
                if (r[2])
                  return Q.apply(n, J.call(t.getElementsByTagName(e), 0)), n;
                if ((a = r[3]) && B.getByClassName && t.getElementsByClassName)
                  return Q.apply(n, J.call(t.getElementsByClassName(a), 0)), n;
              }
            if (B.qsa && !D.test(e)) {
              if (
                ((d = !0),
                ...
                for (
                  ...
                  p[l] = f + c(p[l]);
                (h = (ue.test(e) && t.parentNode) || t), (m = p.join(","));
              }
              if (m)
                try {
                  return Q.apply(n, J.call(h.querySelectorAll(m), 0)), n;
                } catch (e) {
                } finally {
        ...
        function u(e, t) {
          ...
          for (s = e, l = [], u = T.preFilter; s; ) {
            (!n || (i = ie.exec(s))) &&
              ...
              (i = re.exec(s)) &&
                ((n = i.shift()),
                r.push({ value: n, type: i[0].replace(ne, " ") }),
                (s = s.slice(n.length)));
            for (o in T.filter)
              !(i = le[o].exec(s)) ||
                (u[o] && !(i = u[o](i))) ||
          ...
          return (
            ...
            r(function (r, a, s, l) {
              var u,
                ...
                b = !e || (!r && t) ? v : f(v, d, e, s, l),
                y = n ? (o || (r ? e : m || i) ? [] : a) : b;
              if ((n && n(b, y, s, l), i))
                for (u = f(y, h), i(u, [], s, l), c = u.length; c--; )
                  (p = u[c]) && (y[h[c]] = !(b[h[c]] = p));
              if (r) {
                if (o || e) {
                  if (o) {
          ...
          var n = 0,
            ...
            s = function (r, s, l, u, c) {
              var p,
                ...
                y = null != c,
                x = N,
                k = r || (o && T.find.TAG("*", (c && s.parentNode) || s)),
                C = (P += null == x ? 1 : Math.E);
              for (
                y && ((N = s !== $ && s), (w = n));
                null != (p = k[g]);
                ...
                i && ((p = !h && p) && v--, r && b.push(p));
              }
              if (((v += g), i && g !== v)) {
                for (d = 0; (h = t[d]); d++) h(b, m, s, l);
                if (r) {
                  if (v > 0) for (; g--; ) b[g] || m[g] || (m[g] = V.call(u));
                  m = f(m);
                }
                Q.apply(u, m),
                  y &&
        ...
        function b(e, t, n, i) {
          ...
          if (!i && 1 === p.length) {
            if (
              ...
              if (!(t = T.find.ID(a.matches[0].replace(ve, ge), t)[0]))
                return n;
              e = e.slice(o.shift().value.length);
            }
            for (
              r = le.needsContext.test(e) ? -1 : o.length - 1;
              r >= 0 && ((a = o[r]), !T.relative[(s = a.type)]);
              r--
            )
              if (
                (l = T.find[s]) &&
                (i = l(
                  a.matches[0].replace(ve, ge),
                  (ue.test(o[0].type) && t.parentNode) || t
                ))
              ) {
                if ((o.splice(r, 1), !(e = i.length && c(o))))
                  return Q.apply(n, J.call(i, 0)), n;
                break;
              }
          }
          return E(e, p)(i, t, _, n, ue.test(e)), n;
        }
        function y() {}
        var x,
          w,
        ...
        (C = a.isXML =
            ...
            function (e) {
              ...
              return i !== $ && 9 === i.nodeType && i.documentElement
                ? (($ = i),
                  (j = i.documentElement),
                  (_ = C(i)),
                  (B.tagNameNoComments = o(function (e) {
                    return (
                  ...
                  (B.getByName = o(function (e) {
                    ...
                    var t =
                      i.getElementsByName &&
                      i.getElementsByName(O).length ===
                        2 + i.getElementsByName(O + 0).length;
                    return (
                      (B.getIdNotName = !i.getElementById(O)),
                      j.removeChild(e),
                      t
                    );
                  })),
                  ...
                  (T.find.TAG = B.tagNameNoComments
                    ? function (e, n) {
                        return typeof n.getElementsByTagName !== X
                  ...
                  (T.find.NAME =
                    B.getByName &&
                    function (e, n) {
                      return typeof n.getElementsByName !== X
                  ...
                  (T.find.CLASS =
                    B.getByClassName &&
                    function (e, n) {
                      return typeof n.getElementsByClassName === X || _
                        ? t
                        : n.getElementsByClassName(e);
                    }),
                  (L = []),
                  (D = [":focus"]),
                  (B.qsa = n(i.querySelectorAll)) &&
                    (o(function (e) {
                      (e.innerHTML =
          ...
          (a.matchesSelector = function (e, t) {
            if (
              ...
              (t = t.replace(me, "='$1']")),
              !(!B.matchesSelector || _ || (L && L.test(t)) || D.test(t)))
            )
              try {
                var n = H.call(e, t);
                if (
          ...
          (a.uniqueSort = function (e) {
            var t,
              ...
              i = 1,
              r = 0;
            if (((S = !B.detectDuplicates), e.sort(q), S)) {
          ...
          (T = a.selectors =
            {
              ...
              pseudos: {
                ...
                lang: r(function (e) {
                  return (
                    ae.test(e || "") || a.error("unsupported lang: " + e),
                    (e = e.replace(ve, ge).toLowerCase()),
                    function (t) {
                      var n;
                      do {
          ...
          function (e, t) {
            ...
            if (!o) {
              for (t || (t = u(e)), n = t.length; n--; )
                (o = m(t[n])), o[O] ? i.push(o) : r.push(o);
              o = W(e, v(r, i));
            }
            return o;
          }),
          (T.pseudos.nth = T.pseudos.eq),
          (T.filters = y.prototype = T.pseudos),
          (T.setFilters = new y()),
          A(),
          (a.attr = se.attr),
          (se.find = a),
    ...
    se.fn.extend({
      find: function (e) {
        ...
        for (n = [], t = 0; this.length > t; t++) se.find(e, this[t], n);
        return (
          (n = this.pushStack(se.unique(n))),
      ...
      is: function (e) {
        return (
          ...
          ("string" == typeof e
            ? Ie.test(e)
              ? se(e, this.context).index(this[0]) >= 0
              : se.filter(e, this).length > 0
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            o = [],
            a =
              Ie.test(e) || "string" != typeof e ? se(e, t || this.context) : 0;
          r > i;
          i++
        )
          for (
      ...
      add: function (e, t) {
        var n =
            "string" == typeof e
              ? se(e, t)
              : se.makeArray(e && e.nodeType ? [e] : e),
          i = se.merge(this.get(), n);
        return this.pushStack(se.unique(i));
      },
      addBack: function (e) {
        return this.add(
        ...
        function (e, t) {
          se.fn[e] = function (n, i) {
            ...
            return (
              ...
              (r = this.length > 1 && !ze[e] ? se.unique(r) : r),
              this.length > 1 && Pe.test(e) && (r = r.reverse()),
              this.pushStack(r)
            );
          };
        }
    ...
    var We =
      ...
      rt = {
        ...
        _default: se.support.htmlSerialize
          ? [0, "", ""]
          : [1, "X<div>", "</div>"],
      },
      ot = d(V),
    ...
    (rt.optgroup = rt.option),
      ...
      se.fn.extend({
        ...
        remove: function (e, t) {
          for (var n, i = 0; null != (n = this[i]); i++)
            (!e || se.filter(e, [n]).length > 0) &&
              (t || 1 !== n.nodeType || se.cleanData(y(n)),
              n.parentNode &&
                (t && se.contains(n.ownerDocument, n) && v(y(n, "script")),
                n.parentNode.removeChild(n)));
          return this;
        },
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++) {
            for (1 === e.nodeType && se.cleanData(y(e, !1)); e.firstChild; )
            ...
            function (e) {
              ...
              if (
                !(
                  "string" != typeof e ||
                  Ke.test(e) ||
                  (!se.support.htmlSerialize && Ue.test(e)) ||
                  (!se.support.leadingWhitespace && Ve.test(e)) ||
                  rt[(Je.exec(e) || ["", ""])[1].toLowerCase()]
                )
              ) {
                e = e.replace(Qe, "<$1></$2>");
                try {
                  for (; r > i; i++)
                    (n = this[i] || {}),
                      1 === n.nodeType &&
                        (se.cleanData(y(n, !1)), (n.innerHTML = e));
                  n = 0;
                } catch (e) {}
              }
        ...
        domManip: function (e, n, i) {
          ...
          if (
            b ||
            (!(1 >= p || "string" != typeof g || se.support.checkClone) &&
              et.test(g))
          )
            return this.each(function (r) {
              var o = d.eq(r);
              b && (e[0] = g.call(this, r, n ? o.html() : t)),
                o.domManip(e, n, i);
            });
          if (
            p &&
            ...
            for (
              n = n && se.nodeName(o, "tr"),
                a = se.map(y(r, "script"), h),
                s = a.length;
              p > c;
              c++
            )
              (l = r),
                c !== v &&
                  ((l = se.clone(l, !0, !0)), s && se.merge(a, y(l, "script"))),
                i.call(
                  n && se.nodeName(this[c], "table")
                    ? f(this[c], "tbody")
                    : this[c],
                  l,
                  c
            ...
            if (s)
              for (
                u = a[a.length - 1].ownerDocument, se.map(a, m), c = 0;
                s > c;
                c++
              )
                (l = a[c]),
                  tt.test(l.type || "") &&
                    !se._data(l, "globalEval") &&
                    se.contains(u, l) &&
                    (l.src
                      ? se.ajax({
                          url: l.src,
      ...
      se.each(
        ...
        function (e, t) {
          se.fn[e] = function (e) {
            for (var n, i = 0, r = [], o = se(e), a = o.length - 1; a >= i; i++)
      ...
      se.extend({
        clone: function (e, t, n) {
          ...
          if (
            ...
            !(
              (se.support.noCloneEvent && se.support.noCloneChecked) ||
              (1 !== e.nodeType && 11 !== e.nodeType) ||
              se.isXMLDoc(e)
            ))
          )
            for (i = y(s), r = y(e), a = 0; null != (o = r[a]); ++a)
              i[a] && b(o, i[a]);
          if (t)
            if (n)
              for (r = r || y(e), i = i || y(s), a = 0; null != (o = r[a]); a++)
                g(o, i[a]);
            else g(e, s);
          return (
            (i = y(s, "script")),
            i.length > 0 && v(i, !l && y(e, "script")),
            (i = r = o = null),
            s
          );
        },
        buildFragment: function (e, t, n, i) {
          for (
            var r, o, a, s, l, u, c, p = e.length, f = d(t), h = [], m = 0;
            p > m;
            m++
          )
            if ((o = e[m]) || 0 === o)
              if ("object" === se.type(o)) se.merge(h, o.nodeType ? [o] : o);
                ...
                for (
                  s = s || f.appendChild(t.createElement("div")),
                    ...
                    l = rt[a] || rt._default,
                    s.innerHTML = l[1] + o.replace(Qe, "<$1></$2>") + l[2],
                    c = l[0];
                  c--;
                ...
                if (
                  ...
                  for (
                    ...
                    se.nodeName((u = o.childNodes[c]), "tbody") &&
                      !u.childNodes.length &&
                      o.removeChild(u);
                for (
                  se.merge(h, s.childNodes), s.textContent = "";
                  s.firstChild;
          ...
          for (
            s && f.removeChild(s),
              se.support.appendChecked || se.grep(y(h, "input"), x),
              m = 0;
            (o = h[m++]);
            ...
            if (
              (!i || -1 === se.inArray(o, i)) &&
              ((r = se.contains(o.ownerDocument, o)),
        ...
        cleanData: function (e, n) {
          for (
            var i,
              ...
              l = se.expando,
              u = se.cache,
              c = se.support.deleteExpando,
              p = se.event.special;
            null != (o = e[s]);
            s++
          )
            if ((n || se.acceptData(o)) && ((r = o[l]), (i = r && u[r]))) {
              if (i.events)
                for (a in i.events)
                  p[a] ? se.event.remove(o, a) : se.removeEvent(o, a, i.handle);
              u[r] &&
                (delete u[r],
                c
                  ? delete o[l]
    ...
    se.fn.extend({
        ...
        return se.access(
          ...
          function (e, n, i) {
            var r,
              ...
              s = 0;
            if (se.isArray(n)) {
              for (r = lt(e), o = n.length; o > s; s++)
                a[n[s]] = se.css(e, n[s], !1, r);
              return a;
            }
            return i !== t ? se.style(e, n, i) : se.css(e, n);
          },
          e,
          n,
          arguments.length > 1
      ...
      se.extend({
        ...
        style: function (e, n, i, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var o,
              ...
              u = e.style;
            if (
              ((n = se.cssProps[l] || (se.cssProps[l] = w(u, l))),
              (s = se.cssHooks[n] || se.cssHooks[l]),
              i === t)
            )
            ...
            if (
              ...
              "string" === a &&
                (o = gt.exec(i)) &&
                ((i = (o[1] + 1) * o[2] + parseFloat(se.css(e, n))),
                (a = "number")),
              !(
                null == i ||
                ("number" === a && isNaN(i)) ||
                ("number" !== a || se.cssNumber[l] || (i += "px"),
                se.support.clearCloneStyle ||
                  "" !== i ||
        ...
        css: function (e, n, i, r) {
          var o,
            ...
            l = se.camelCase(n);
          return (
            (n = se.cssProps[l] || (se.cssProps[l] = w(e.style, l))),
            (s = se.cssHooks[n] || se.cssHooks[l]),
            s && "get" in s && (o = s.get(e, !0, i)),
            o === t && (o = st(e, n, r)),
            "normal" === o && n in xt && (o = xt[n]),
            i
              ? ((a = parseFloat(o)), !0 === i || se.isNumeric(a) ? a || 0 : o)
              : o
          );
        },
      ...
      se.each(["height", "width"], function (e, n) {
        se.cssHooks[n] = {
          get: function (e, i, r) {
            return i
              ? 0 === e.offsetWidth && ft.test(se.css(e, "display"))
                ? se.swap(e, yt, function () {
                    return S(e, n, r);
                  })
                : S(e, n, r)
              : t;
            ...
            return C(
              ...
              i
                ? E(
                    ...
                    i,
                    se.support.boxSizing &&
                      "border-box" === se.css(e, "boxSizing", !1, r),
                    r
                  )
                : 0
            );
      ...
      se.support.opacity ||
        (se.cssHooks.opacity = {
          ...
          set: function (e, t) {
            var n = e.style,
              i = e.currentStyle,
              r = se.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
              o = (i && i.filter) || n.filter || "";
            (n.zoom = 1),
              ((t >= 1 || "" === t) &&
                "" === se.trim(o.replace(ct, "")) &&
                n.removeAttribute &&
                (n.removeAttribute("filter"), "" === t || (i && !i.filter))) ||
                (n.filter = ct.test(o) ? o.replace(ct, r) : o + " " + r);
          },
        }),
      se(function () {
        se.support.reliableMarginRight ||
          (se.cssHooks.marginRight = {
            get: function (e, n) {
              return n
                ? se.swap(e, { display: "inline-block" }, st, [
                    e,
                    "marginRight",
                  ])
                : t;
            ...
            se.each(["top", "left"], function (e, n) {
              se.cssHooks[n] = {
                get: function (e, i) {
                  return i
                    ? ((i = st(e, n)),
                      vt.test(i) ? se(e).position()[n] + "px" : i)
                    : t;
                },
              };
            });
      ...
      se.expr &&
        ...
        ((se.expr.filters.hidden = function (e) {
          return (
            ...
            (!se.support.reliableHiddenOffsets &&
    ...
    var kt = /%20/g,
      Ct = /\[\]$/,
      Et = /\r?\n/g,
      St = /^(?:submit|button|image|reset)$/i,
    ...
    se.fn.extend({
      ...
      (se.param = function (e, n) {
        ...
        if (
          (n === t && (n = se.ajaxSettings && se.ajaxSettings.traditional),
    ...
    try {
      ...
      ($t = V.createElement("a")), ($t.href = ""), ($t = $t.href);
    }
    (At = Ft.exec($t.toLowerCase()) || []),
      (se.fn.load = function (e, n, i) {
      ...
      se.each(["get", "post"], function (e, n) {
        se[n] = function (e, i, r, o) {
          return (
            se.isFunction(i) && ((o = o || r), (r = i), (i = t)),
            se.ajax({ url: e, type: n, dataType: o, data: i, success: r })
          );
        };
      }),
      se.extend({
        ...
        ajaxSetup: function (e, t) {
          return t ? D(D(e, se.ajaxSettings), t) : D(se.ajaxSettings, e);
        },
        ajaxPrefilter: j(Pt),
        ajaxTransport: j(Rt),
        ajax: function (e, n) {
            ...
            2 !== x &&
              ...
              (e >= 200 && 300 > e) || 304 === e
                ? (d.ifModified &&
                    ...
                    (w = T.getResponseHeader("etag")) && (se.etag[o] = w)),
                  304 === e
                    ? ((u = !0), (k = "notmodified"))
                    : ((u = H(d, y)),
                      (k = u.state),
              ...
              (T.status = e),
              (T.statusText = (n || k) + ""),
              u ? m.resolveWith(f, [p, k, T]) : m.rejectWith(f, [T, k, b]),
              T.statusCode(g),
              (g = t),
              c &&
                h.trigger(u ? "ajaxSuccess" : "ajaxError", [T, d, u ? p : b]),
              v.fireWith(f, [T, k]),
              c &&
          ...
          var r,
            ...
            d = se.ajaxSetup({}, n),
            f = d.context || d,
            h = d.context && (f.nodeType || f.jquery) ? se(f) : se.event,
            m = se.Deferred(),
          ...
          if (
            ...
            d.data &&
              ...
              (d.data = se.param(d.data, d.traditional)),
            _(Pt, d, n, T),
            2 === x)
          )
            return T;
          (c = d.global),
            ...
            d.ifModified &&
              (se.lastModified[o] &&
                T.setRequestHeader("If-Modified-Since", se.lastModified[o]),
      ...
      se.ajaxTransport("script", function (e) {
        if (e.crossDomain) {
          var n,
            i = V.head || se("head")[0] || V.documentElement;
          return {
            send: function (t, r) {
    ...
    se.ajaxSetup({
      ...
      jsonpCallback: function () {
        var e = zt.pop() || se.expando + "_" + jt++;
        return (this[e] = !0), e;
      },
    }),
      se.ajaxPrefilter("json jsonp", function (n, i, r) {
        var o,
          a,
          s,
          l =
        ...
        return l || "jsonp" === n.dataTypes[0]
          ? ((o = n.jsonpCallback =
              se.isFunction(n.jsonpCallback)
                ? n.jsonpCallback()
                : n.jsonpCallback),
            l
              ? (n[l] = n[l].replace(Wt, "$1" + o))
              : !1 !== n.jsonp &&
                (n.url += (_t.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
            ...
            r.always(function () {
              (e[o] = a),
                n[o] && ((n.jsonpCallback = i.jsonpCallback), zt.push(o)),
    ...
    (se.ajaxSettings.xhr = e.ActiveXObject
      ...
      : M),
      (Ut = se.ajaxSettings.xhr()),
      (se.support.cors = !!Ut && "withCredentials" in Ut),
      (Ut = se.support.ajax = !!Ut) &&
        se.ajaxTransport(function (n) {
        ...
        "*": [
          function (e, t) {
            ...
            if (o) {
              if (
                ((n = +o[2]),
                "px" !== (i = o[3] || (se.cssNumber[e] ? "" : "px")) && s)
              ) {
                s = se.css(r.elem, e, !0) || n || 1;
                do {
                  (l = l || ".5"), (s /= l), se.style(r.elem, e, s + i);
    ...
    (se.Animation = se.extend(B, {
      ...
      se.fn.extend({
        ...
        animate: function (e, t, n, i) {
          var r = se.isEmptyObject(e),
            o = se.speed(t, n, i),
            a = function () {
              var t = B(this, se.extend({}, e), o);
              (a.finish = function () {
                t.stop(!0);
              }),
                (r || se._data(this, "finish")) && t.stop(!0);
            };
          return (
            (a.finish = a),
        ...
        stop: function (e, n, i) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (n in a) a[n] && a[n].stop && Zt.test(n) && r(a[n]);
              for (n = o.length; n--; )
                o[n].elem !== this ||
                  (null != e && o[n].queue !== e) ||
      ...
      (se.speed = function (e, t, n) {
        ...
        return (
          (i.duration = se.fx.off
            ? 0
            : "number" == typeof i.duration
            ? i.duration
            : i.duration in se.fx.speeds
            ? se.fx.speeds[i.duration]
      ...
      (se.fx.tick = function () {
        var e,
          n = se.timers,
          i = 0;
        for (Jt = se.now(); n.length > i; i++)
          (e = n[i])() || n[i] !== e || n.splice(i--, 1);
        n.length || se.fx.stop(), (Jt = t);
      }),
      ...
      (se.fx.start = function () {
        Yt || (Yt = setInterval(se.fx.tick, se.fx.interval));
      }),
      (se.fx.stop = function () {
      ...
      (se.offset = {
        setOffset: function (e, t, n) {
          ...
          var r,
            ...
            c =
              ("absolute" === i || "fixed" === i) &&
              se.inArray("auto", [l, u]) > -1,
            p = {},
            d = {};
          c
            ? ((d = a.position()), (r = d.top), (o = d.left))
            : ((r = parseFloat(l) || 0), (o = parseFloat(u) || 0)),
  ...
  function () {
      ...
      k.inject =
        function (e, t, n, i) {
          ...
          if ((null == e && (e = []), f && e.reduce === f))
            return i && (t = k.bind(t, i)), r ? e.reduce(t, n) : e.reduce(t);
          if (
            (C(e, function (e, o, a) {
    ...
    var $ = function (e, t, n) {
      return (
        C(e, function (e) {
          k.isArray(e) ? (t ? a.apply(n, e) : $(e, t, n)) : n.push(e);
        }),
        n
      );
    };
    (k.flatten = function (e, t) {
      ...
      (k.uniq = k.unique =
        function (e, t, n, i) {
          ...
          return (
            C(r, function (n, i) {
              (t ? i && a[a.length - 1] === n : k.contains(a, n)) ||
                (a.push(n), o.push(e[i]));
            }),
            o
          );
      ...
      (k.indexOf = function (e, t, n) {
        ...
        if (n) {
          if ("number" != typeof n)
            return (i = k.sortedIndex(e, t)), e[i] === t ? i : -1;
    ...
    var j = function (e, t, n, i) {
      ...
      if ("[object Array]" == r) {
        ...
        if (
          ...
          return !1;
        for (var p in e)
          if (k.has(e, p) && (a++, !(s = k.has(t, p) && j(e[p], t[p], n, i))))
            break;
        if (s) {
          for (p in t) if (k.has(t, p) && !a--) break;
          s = !a;
        }
      }
    ...
    (k.template = function (e, t, n) {
      ...
      e.replace(r, function (t, n, i, r, s) {
        return (
          (a += e.slice(o, s).replace(q, function (e) {
            return "\\" + M[e];
          })),
  ...
  function () {
    ...
    o.extend(u.prototype, l, {
      ...
      url: function () {
        var e = S(this, "urlRoot") || S(this.collection, "url") || N();
        return this.isNew()
          ? e
          : e +
              ("/" == e.charAt(e.length - 1) ? "" : "/") +
    ...
    u.extend = c.extend = d.extend = y.extend = T;
    var k = { create: "POST", update: "PUT", delete: "DELETE", read: "GET" };
    (e.sync = function (t, n, i) {
      var r = k[t];
      i || (i = {});
      var s = { type: r, dataType: "json" };
      return (
        i.url || (s.url = S(n, "url") || N()),
        i.data ||
          !n ||
          ("create" != t && "update" != t) ||
  ...
  define(
    ...
    function (e) {
      var t = e("text!templates/snippet/formname.html"),
        ...
        v = e("text!templates/snippet/prependedcheckbox.html"),
        n = e("text!templates/snippet/prependedtext.html"),
        g = e("text!templates/snippet/searchinput.html"),
        b = e("text!templates/snippet/selectbasic.html"),
        y = e("text!templates/snippet/selectmultiple.html"),
        x = e("text!templates/snippet/textarea.html"),
        r = e("text!templates/snippet/textinput.html");
      return {
        formname: t,
        prependedtext: n,
      ...
      t && t.preventDefault(),
        ...
        t.isDefaultPrevented() ||
          ...
          e.support.transition && o.hasClass("fade")
            ? o.one(e.support.transition.end, n).emulateTransitionEnd(150)
            : n());
    };
    var i = e.fn.alert;
        ...
        if (e.length) {
          "radio" ===
            this.$element
              ...
              .trigger("change")
              .prop("type") && e.find(".active").removeClass("active");
        }
  ...
  (function (e) {
    ...
    (e.fn.carousel = function (n) {
      return this.each(function () {
        ...
        r || i.data("bs.carousel", (r = new t(this, o))),
          "number" == typeof n
            ? r.to(n)
            : a
            ? r[a]()
      ...
      e(document).on(
        ...
        function (t) {
          ...
          a && (o.interval = !1),
            r.carousel(o),
            (a = i.attr("data-slide-to")) && r.data("bs.carousel").to(a),
            t.preventDefault();
        }
      ),
    ...
    (e.fn.collapse = function (n) {
      return this.each(function () {
        var i = e(this),
          ...
          o = e.extend({}, t.DEFAULTS, i.data(), "object" == typeof n && n);
        r || i.data("bs.collapse", (r = new t(this, o))),
          "string" == typeof n && r[n]();
      });
    }),
          ...
          (a && a.transitioning) ||
            (u &&
              u
                ...
                .not(i)
                .addClass("collapsed"),
            i[o.hasClass("in") ? "addClass" : "removeClass"]("collapsed")),
            o.collapse(s);
        }
      );
  })(window.jQuery),
    ...
    function t() {
      e(i).remove(),
        e(r).each(function (t) {
          var i = n(e(this));
          i.hasClass("open") &&
            (i.trigger((t = e.Event("hide.bs.dropdown"))),
            t.isDefaultPrevented() ||
          ...
          if (
            ("ontouchstart" in document.documentElement &&
              ...
              e('<div class="dropdown-backdrop"/>')
                .insertAfter(e(this))
                .on("click", t),
            o.trigger((i = e.Event("show.bs.dropdown"))),
        ...
        if (/(38|40|27)/.test(t.keyCode)) {
          ...
          if (
            ...
            var o = n(i),
              a = o.hasClass("open");
            if (!a || (a && 27 == t.keyCode))
              return 27 == t.which && o.find(r).focus(), i.click();
      ...
      e(document).on(
        ...
        function (t) {
          var n = e(this),
            ...
            o = r.data("modal")
              ? "toggle"
              : e.extend({ remote: !/#/.test(i) && i }, r.data(), n.data());
          t.preventDefault(),
        ...
        if ((this.$element.trigger(r), !r.isDefaultPrevented()))
          return (
            ...
            e.support.transition && this.$tip.hasClass("fade")
              ? i.one(e.support.transition.end, t).emulateTransitionEnd(150)
              : t(),
  ...
  (function (e) {
    ...
    (t.prototype.show = function () {
      ...
      (t.prototype.activate = function (t, n, i) {
        ...
        a ? o.one(e.support.transition.end, r).emulateTransitionEnd(150) : r(),
          o.removeClass("in");
      });
    var n = e.fn.tab;
    (e.fn.tab = function (n) {
      ...
      (t.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
          ...
          var l =
            ...
            (null != s && r.top + this.$element.height() >= n - s
              ? "bottom"
              : null != a && i <= a && "top");
          this.affixed !== l &&
            (this.unpin && this.$element.css("top", ""),
            (this.affixed = l),
            (this.unpin = "bottom" == l ? r.top - i : null),
            this.$element
              .removeClass(t.RESET)
              .addClass("affix" + (l ? "-" + l : "")),
            "bottom" == l &&
    ...
    (e.fn.affix = function (n) {
      return this.each(function () {
        var i = e(this),
          r = i.data("bs.affix"),
          o = "object" == typeof n && n;
        r || i.data("bs.affix", (r = new t(this, o))),
          "string" == typeof n && r[n]();
      });
    }),
